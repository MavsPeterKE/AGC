...
@Database(entities = {Customer.class, Screen.class, GameCount.class, CompletedGame.class, GameType.class, CustomerVisit.class, Promotion.class},views = {GameView.class, CustomerView.class},
