...
public final class Prefs {
    ...
    /**
     * ProductReturn the underlying SharedPreference instance
     *
    ...
    /**
     * @return ProductReturn a map containing a list of pairs key/value representing
     * the preferences.
     ...
     * @return ProductReturn the preference value if it exists, or defValue.
     ...
     *
     * @param key The name of the preference to retrieve.
     * @return ProductReturn the preference value if it exists, or 0.
     * @throws ClassCastException if there is a preference with this name that is not
     *                            an int.
     * @see SharedPreferences#getInt(String, int)
     */
     ...
     *
     * @param key The name of the preference to retrieve.
     * @return ProductReturn the preference value if it exists, or false.
     * @throws ClassCastException if there is a preference with this name that is not a boolean.
     * @see SharedPreferences#getBoolean(String, boolean)
     */
    ...
    /**
     * ProductReturn the double that has been saved as a long raw bits value in the long preferences.
     *
     * @param key      The name of the preference to retrieve.
    ...
    /**
     * ProductReturn the double that has been saved as a long raw bits value in the long preferences.
     * ProductReturn 0 if the preference does not exist.
     *
     * @param key The name of the preference to retrieve.
     * @return ProductReturn the preference value if it exists, or 0.
     * @throws ClassCastException if there is a preference with this name that is not a long.
     ...
     *
     * @param key The name of the preference to retrieve.
     * @return ProductReturn the preference value if it exists, or "".
     * @throws ClassCastException if there is a preference with this name that is not a String.
     * @see SharedPreferences#getString(String, String)
     */
     ...
     * @param key      The name of the preference to retrieve.
     * @param defValue Value to return if this preference does not exist.
     * @return ProductReturn the preference values if they exist, or defValues otherwise.
     ...
     * @param key      The name of the preference to retrieve.
     * @param defValue Value to return if this preference does not exist.
     * @return ProductReturn the preference value if it exists, or defValues otherwise.
    ...
    /**
     * ProductReturn the Editor of the underlying SharedPreferences instance.
     *
     * @return An Editor
     */
    ...
    public final static class Builder {
        ...
        public void build() {
            ...
            com.example.arcgbot.utils.Prefs.initPrefs(mContext, mKey, mMode);
        }
