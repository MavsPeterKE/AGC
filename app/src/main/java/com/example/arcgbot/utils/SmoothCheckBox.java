...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        boolean checked = ta.getBoolean(R.styleable.SmoothCheckBox_checked, CHECKED);
        // TODO: 5/28/19 REMOVE THIS CHECKED
        //setChecked(checked);
        ta.recycle();
    ...
    public void setChecked(boolean checked, boolean animate) {
        if (animate) {
            ...
            if (mListener != null) {
                mListener.onCheckedChanged(com.example.arcgbot.utils.SmoothCheckBox.this, mChecked);
            }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(com.example.arcgbot.utils.SmoothCheckBox checkBox, boolean isChecked);
    }
}
